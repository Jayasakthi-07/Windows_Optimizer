...
echo Windows_Optimizer Launcher by JAYASAKTHI Tools
goto int
...
set github-link=https://github.com/Jayasakthi-07
...
echo.
echo                                               [40;33m ╔═════════════════════════════════╗
echo                                               [40;33m ║        Windows_Optimizer        ║
echo                                               [40;33m ║        coded by JAYASAKTHI      ║
echo                                               [40;33m ╚═════════════════════════════════╝    

title Windows_Optimizer %ver% by JAYASAKTHI
echo.
...
:info
cls
echo Windows_Optimizer
echo %ver% by JAYASAKTHI
echo.
echo Source code available on GitHub: %github-link%
